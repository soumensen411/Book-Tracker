      ...
      <div className="w-full md:w-3/4 lg:w-1/2 ">
        <ul className="list bg-base-100 rounded-box  shadow-md ">
          {books.map((book, index) => (
            <li
              key={book.id}
              className="rounded-lg list-row flex flex-col sm:flex-row gap-4 p-3 mt-2 border border-neutral-500 items-center"
            >
              ...
              <div>
                <img
                  className="size-15 rounded-box rounded-lg object-cover"
              ...
              <div className="flex flex-wrap justify-center gap-2">
                <button
                  ...
                  className="btn bg-transparent border border-neutral-500 rounded-lg"
                >
                ...
                <button
                  ...
                  className="rounded-lg font-thin  btn btn-square btn-ghost items-center border border-neutral-500"
                >
                  ❌
                </button>
              </div>
